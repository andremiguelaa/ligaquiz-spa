    ...
    <div className="section content">
      <Trans>
        ...
        <ol className="rules">
          <li>
            <span>
              ...
              honestidade dos jogadores é crucial. É expressamente proibido usar
          ...
          <li>
            A organização reserva-se ao direito de inibir o acesso à Liga Quiz a
            qualquer jogador que não cumpra este critério.
          </li>
          <li>
            Para receber um convite para entrar na Liga Quiz, todos os novos
            jogadores deverão ser referidos por um jogador activo na Liga Quiz,
            que irá atestar da honestidade e integridade do novo membro. A Liga
            Quiz é uma liga por convite.
          </li>
          <li>
            Todos os estreantes na Liga Quiz serão colocados na divisão mais
            baixa. A preferência de entrada numa divisão é a ordem de entrada na
            lista de espera.
          </li>
          <li>
            ...
            disponível.
            <br />
            Caso um jogador saia da Liga Quiz temporariamente com aviso prévio,
            por um período máximo de 3 meses, será colocado na mesma divisão em
            que estava quando saiu; existindo os naturais ajustes de descidas de
            divisão.
            <br />
          ...
          <li>
            ...
            dos outros membros da mesma divisão e duas vezes sem adversário (no
            10º dia e no 20º dia).
          </li>
          ...
          <li>
            ...
            altere a fonética da resposta e não esteja explícito na pergunta que
            a correcção ortográfica é obrigatória. Este não é um jogo de
            ortografia mas sim de cultural geral.
          </li>
          <li>
            Quando a resposta é o nome de uma pessoa é aceite como certa se for
            respondido apenas o apelido ou nome pelo qual é mais conhecido,
            excepto se na pergunta estiver explícito que é pedido mais isso.
            <br />
          ...
          <li>
            <span>
              ...
              terá atribuído qualquer ponto na classificação e o adversário será
          ...
          <li>
            ...
            cada resposta correcta e um ponto por participar na ronda, ou seja,
            um máximo de 5 pontos.
          </li>
          <li>
            No final dos 20 jogos os 2 piores classificados serão relegados para
            a divisão imediatamente inferior (caso exista) e os 2 melhores
          ...
          <li>
            A divisão Carolina Beatriz Ângelo é de acesso exclusivo a jogadores
            com ranking nacional, ou seja, que tenham um jogo ao vivo a contar
            para o ranking nos últimos 12 meses. Serão feitos os ajustes
            necessários às subidas/descidas para que isso se verifique.
          </li>
          <li>
            O primeiro classificado da divisão Carolina Beatriz Ângelo no final
            dos 20 jogos é declarado o campeão mensal da Liga Quiz.
          </li>
          <li>
            <span>
        ...
        <p>
          ...
          perguntas que não contarão para a classificação da liga havendo apenas
          uma classificação do respectivo quiz.
        </p>
        ...
        <ul>
          ...
          <li>
            Por transferência bancária para a conta com o seguinte IBAN enviando
            o comprovativo para{' '}
        ...
        <p>
          ...
          final do dia de sábado antes do início da mesma. Cada temporada mensal
          começa na primeira segunda-feira de cada mês.
        </p>
      </Trans>
    </div>
  </>
